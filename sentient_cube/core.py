...
from sentient_cube.control.hardware import HardwareConfig, HardwareController, build_hardware_controller
...
class SentientCubeCore:
    def __init__(
        ...
        self.hardware = hardware_controller or build_hardware_controller(hardware_config)
